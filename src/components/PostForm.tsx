...
const PostForm = ({ maxCharacters, postType, ...props }: Props) => {
    ...
    if (postType === "story") return (
        <form {...props} onSubmit={props.onSubmit!} className="w-full h-[40vh] gap-5">
            <div className="grid grid-cols-1 lg:grid-cols-2 w-full items-center justify-between text-center gap-5 h-64">
